<?php 
	...
	$data_dsn = mysqli_query($koneksi,"SELECT * FROM dosen");
 	// menghitung data sopir
	$jumlah_dsn = mysqli_num_rows($data_dsn);

	// mengambil data matakuliah
	$data_matkul = mysqli_query($koneksi,"SELECT * FROM matakuliah");
	...
	$data_kul = mysqli_query($koneksi,"SELECT * FROM perkuliahan");
 	// menghitung data perkuliahan
	$jumlah_kul = mysqli_num_rows($data_kul);
?>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php echo $jumlah_matkul; ?></span>
